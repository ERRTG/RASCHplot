...
Yen's Q3 statistics are computed using the `Q3star()` function:

```{r}
q3obj <- Q3star(items = it.SPADI, method.item = "CML", method.person = "WML", model = "RMP")
```

Here CML is used for estimating item parameters and WML is used for estimating person parameters. Other options are available, see `?Q3star`.
